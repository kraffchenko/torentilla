...
namespace net{
  std::string Request::url_encode(std::array<std::byte, 20> byte_array){
   ...
   size_t Request::callback(char* data, size_t size, size_t nmemb, void* clientp){
  ...
  std::vector<std::byte> Request::trackerGetRequest(torrent::Download& download_structure, std::array<std::byte, 20> peer_id){
