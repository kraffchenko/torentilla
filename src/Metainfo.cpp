...
Metainfo::Metainfo(std::string_view announce, int64_t piece_length, std::vector<std::byte>& pieces, std::string_view name,
        ...
        std::optional<int> is_private=std::nullopt, std::optional<std::reference_wrapper<std::vector<std::byte>>> md5sum=std::nullopt)
