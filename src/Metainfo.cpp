...
Metainfo::Metainfo(std::string_view announce, int64_t piece_length, std::string_view pieces, std::string_view name,
        int64_t length, std::array<std::byte, 20> info_hash, std::optional<std::vector<std::vector<std::string>>> announce_list=std::nullopt, std::optional<int64_t>  creation_date=std::nullopt, std::optional<std::string_view> comment=std::nullopt, 
