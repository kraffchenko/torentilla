...
Metainfo::Metainfo(std::string_view announce, int64_t piece_length, std::string_view pieces, std::string_view name,
        ...
        : m_announce{announce}, m_piece_length {piece_length}, m_pieces{pieces}, m_name{name}, m_length{length}, m_announce_list{announce_list}, m_creation_date{creation_date},
